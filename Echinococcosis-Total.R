...
expohi = ggplot(test, aes(GBD, total)) +
  ...
  xlab("Echinococcosis DALYS") +
  ylab("Global One Health Intrinsic Drivers Index scores")+
  theme_test() 

ggsave("OHI-Echinococcosis-region.pdf", width=8, height=4, dpi=600)
