...
expohi = ggplot(test, aes(GBD, total)) +
  ...
  xlab("Leishimaniasis DALYS") +
  ylab("Global One Health Intrinsic Drivers Index scores")+
  theme_test() 

ggsave("OHI-Leishimaniasis-region.pdf", width=8, height=4, dpi=600)
